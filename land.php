...
if ($a1==$name && $a2==$passwd) {
    ...
    <div class="row notice" style="color: #6d757a">
        <div class="col-md-6">
            ...
            <p>6，添加网址必须带上http或https，暂时是这样。</p>
            <p>7，需要使用未登录的默认站点，<a href="./index-bak.php">点击这里</a>。</p>
            <p>8，后期代码开源并有视屏教程，大神勿喷。</p>
            <br><br><br>
        </div>
        <div>
...
?>
    <div class="about">
        <a href="www.yaoyao.ink">个人Blog</a>&nbsp&nbsp&nbsp <a href="https://space.bilibili.com/31126513/#/">Bilibili</a>
    </div>
